...
--custom-color-1: #0dcaf0;
--custom-color-1-darker: #0cb6d8;
--custom-color-1-r: 13;
--custom-color-1-g: 202;
--custom-color-1-b: 240;
--custom-color-1-contrast: white;
--custom-color-1-contrast-darker: white;
--custom-color-1-text-color: var(--body-alt-color);
--custom-color-2: #5d6060;
--custom-color-2-darker: #545656;
--custom-color-2-r: 93;
--custom-color-2-g: 96;
--custom-color-2-b: 96;
...
--bg-contrast: var(--body-color);
        ...
        {
            color: var(--custom-color-2) !important;
        }</style><style id="typography" typography="custom-page-typography-3">
        .u-body
        {
        ...
        --theme-sheet-width-xl: 1920px;
        --theme-sheet-width-lg: 1199px;
        --theme-sheet-width-md: 720px;
        --theme-sheet-width-sm: 540px;
        --theme-sheet-width-xs: 428px;
        ...
        /** alt-color-rules **/
    </style><style id="font-scheme" font-scheme="custom-font-family-4" heading-font="Rubik-VariableFont_wght" text-font="'Open Sans',sans-serif">.u-body {
   --text-font: 'Open Sans',sans-serif;
   --heading-font: Rubik-VariableFont_wght;
}</style>